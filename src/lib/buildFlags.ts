...
export const BUILD_APP_VERSION = (import.meta.env.VITE_APP_VERSION || "sfw") as AppVersion | string;
...
export const BUILD_IS_NSFW = (import.meta.env.VITE_APP_VERSION || "sfw") === "nsfw";

/** True if this is the SFW variant */
export const BUILD_IS_SFW = (import.meta.env.VITE_APP_VERSION || "sfw") === "sfw";
...
export const BUILD_ALLOW_ADULT_BUNDLE =
  ...
  ((import.meta.env.VITE_APP_VERSION || "sfw") as string) === "nsfw";
