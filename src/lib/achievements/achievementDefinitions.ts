...
export const scanningAchievements: Achievement[] = [
  ...
  },
  {
    ...
    rarity: 'uncommon',
    icon: 'Zap',
    criteria: { type: 'custom', threshold: 5, additionalConditions: { metric: 'scan_time_seconds' } },
    points: 30,
  },
];
...
export const explorationAchievements: Achievement[] = [
  {
    ...
    rarity: 'common',
    icon: 'Layers',
    criteria: { type: 'feature_use', threshold: 1, additionalConditions: { feature: 'ar_overlay' } },
    points: 15,
  },
  {
    id: 'feature_voice',
    ...
    rarity: 'common',
    icon: 'Mic',
    criteria: { type: 'feature_use', threshold: 1, additionalConditions: { feature: 'voice_guidance' } },
    points: 15,
  },
  {
    id: 'feature_enhance',
    ...
    rarity: 'common',
    icon: 'Wand2',
    criteria: { type: 'feature_use', threshold: 1, additionalConditions: { feature: 'image_enhancement' } },
    points: 15,
  },
  {
    id: 'feature_export',
    ...
    rarity: 'uncommon',
    icon: 'Download',
    criteria: { type: 'feature_use', threshold: 1, additionalConditions: { feature: 'data_export' } },
    points: 20,
  },
  {
...
export const healthAchievements: Achievement[] = [
  ...
  },
  {
    ...
    rarity: 'uncommon',
    icon: 'ClipboardList',
    criteria: { type: 'feature_use', threshold: 7, additionalConditions: { feature: 'symptom_tracking' } },
    points: 35,
  },
  {
    ...
    rarity: 'common',
    icon: 'Pill',
    criteria: { type: 'feature_use', threshold: 1, additionalConditions: { feature: 'medication_reminders' } },
    points: 15,
  },
];
...
export const specialAchievements: Achievement[] = [
  ...
  },
  {
    ...
    points: 500,
    rewards: [{ type: 'theme', value: 'anniversary_theme', description: 'Exclusive anniversary theme' }],
  },
  {
    ...
    rarity: 'common',
    icon: 'GraduationCap',
    criteria: { type: 'milestone', threshold: 1, additionalConditions: { milestone: 'tutorial_complete' } },
    points: 10,
  },
  {
    id: 'feedback_given',
