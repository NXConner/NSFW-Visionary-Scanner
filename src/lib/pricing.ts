...
export const getPricingTiers = async (): Promise<PricingTier[]> => {
  ...
  const allTiers: PricingTier[] = [
    ...
    },
    {
      ...
      features: ['Everything in Free', 'Unlimited Scans', 'Advanced Analytics', 'Cloud Backup', 'Progress Photos', 'PE Routine Builder']
    },
    {
      ...
      popular: true,
      features: ['Everything in Pro', 'AI Health Chatbot', 'AI Scan Analysis', 'Medical Export (HL7 FHIR)', 'Priority Support', 'Custom PE Routines', 'Predictive Analytics']
    },
    {
    ...
    // NSFW Direct Pricing (Store not available)
    {
      ...
      features: ['All SFW features', 'Positions Gallery', 'NSFW Visual Content', 'Complete visual content system']
    },
    {
    ...
    },
    {
      ...
      popular: true,
      features: ['Everything in SFW Premium', 'All NSFW content', 'Full visual content system', 'Priority NSFW content updates']
    },
    {
    ...
    },
    {
      ...
      features: ['Unlocks all NSFW content', 'Requires base SFW app', '20% discount for direct users']
    }
  ]
