...
export const generateHL7FHIR = (scans: ScanEntry[], diaryEntries: DiaryEntry[]): string => {
  ...
  const organizationId = 'org-growthtracker';
  ...
  const bundle = {
    ...
    identifier: {
      system: 'urn:growthtracker:bundle',
      value: bundleId
    },
    type: 'collection',
    ...
    entry: [
      // Organization resource
      {
        ...
        resource: {
          ...
          active: true,
          name: 'GrowthTracker Self-Assessment',
          type: [{
            coding: [{
        ...
        resource: {
          ...
          component: [
            scan.length && {
              ...
              valueQuantity: { value: scan.length, unit: 'cm', system: 'http://unitsofmeasure.org', code: 'cm' }
            },
            scan.circumference && {
              code: {
              ...
              valueQuantity: { value: scan.circumference, unit: 'cm', system: 'http://unitsofmeasure.org', code: 'cm' }
            },
            scan.curvature_angle && {
              code: {
                coding: [{ system: 'http://snomed.info/sct', code: '246223004', display: 'Curvature angle' }],
                text: 'Curvature Angle'
              },
              valueQuantity: { value: scan.curvature_angle, unit: 'degrees', system: 'http://unitsofmeasure.org', code: 'deg' }
            },
            scan.curvature_direction && {
              code: {
                coding: [{ system: 'http://snomed.info/sct', code: '246267002', display: 'Direction' }],
        ...
        resource: {
          ...
          component: [
            ...
            entry.pain_level !== null && {
              code: {
                coding: [{ system: 'http://snomed.info/sct', code: '225908003', display: 'Pain level' }],
                text: 'Pain Level'
              },
