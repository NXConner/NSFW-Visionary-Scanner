    ...
    steps: [
      {
        ...
        content:
          "This tutorial will guide you through the basic features of the application. The scanner uses advanced AI to analyze images and provide accurate measurements.",
      },
      {
        id: "gs-2",
        title: "Understanding the Interface",
        content:
          "The main interface consists of three areas: the camera view, the control panel, and the results display. Let's explore each one.",
      ...
      },
      {
        ...
        quiz: {
          ...
          correctIndex: 1,
          explanation:
            "The interface has the camera view for capturing, control panel for settings, and results display for analysis.",
        },
      },
      {
        id: "gs-4",
        ...
        content:
          "To perform your first scan, position your device steadily and tap the capture button. The AR overlay will guide you for optimal positioning.",
    ...
    steps: [
      {
        ...
        content:
          "The AR measurement overlay provides real-time guidance for accurate scanning. It uses computer vision to detect reference points and calculate measurements.",
      },
      {
        id: "ar-2",
        title: "Understanding Quality Indicators",
        content:
          "The quality indicator shows your current scan quality based on lighting, stability, angle, distance, and focus. Aim for a score above 80% for best results.",
        quiz: {
          id: "q-ar-1",
      ...
      },
      {
        ...
        content:
          "The positioning prompts will guide you with arrows and instructions. Follow them to achieve the optimal camera position.",
      },
      {
        id: "ar-4",
        title: "Detecting Reference Points",
        content:
          "Reference points appear as circles on the overlay. Green points indicate high confidence, while yellow or red points may need adjustment.",
        quiz: {
          id: "q-ar-2",
    ...
    steps: [
      {
        ...
        content:
          "The health prediction engine uses machine learning to analyze your measurement history and identify trends.",
      },
      {
        id: "aa-2",
        title: "Understanding Trends",
        content:
          "Trends are calculated using moving averages and regression analysis. An upward trend indicates increasing values, while a downward trend shows decreasing values.",
        quiz: {
          id: "q-aa-1",
      ...
      },
      {
        ...
        content:
          "The risk assessment system evaluates your measurements against normal ranges and generates recommendations.",
      },
    ],
  },
];
...
export class TutorialEngine {
  ...
  getStats(): TutorialStats {
    ...
    return {
      ...
      averageScore:
        allQuizScores.length > 0 ? Math.round((correctAnswers / allQuizScores.length) * 100) : 0,
