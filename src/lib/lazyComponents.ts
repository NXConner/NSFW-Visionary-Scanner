...
export const pages = {
  Index: lazyWithRetry(() => import("@/pages/Index").then(m => ({ default: m.default }))),
  Auth: lazyWithRetry(() => import("@/pages/Auth").then(m => ({ default: m.default }))),
  AuthCallback: lazyWithRetry(() =>
    import("@/pages/AuthCallback").then(m => ({ default: m.AuthCallback })),
  ),
  Pricing: lazyWithRetry(() => import("@/pages/Pricing").then(m => ({ default: m.default }))),
  PrivacyPolicy: lazyWithRetry(() =>
    import("@/pages/PrivacyPolicy").then(m => ({ default: m.default })),
  ),
  TermsOfService: lazyWithRetry(() =>
    import("@/pages/TermsOfService").then(m => ({ default: m.default })),
  ),
  NotFound: lazyWithRetry(() => import("@/pages/NotFound").then(m => ({ default: m.default }))),
};
 ...
 */
export async function devOnlyImport<T>(importFn: () => Promise<T>): Promise<T | null> {
