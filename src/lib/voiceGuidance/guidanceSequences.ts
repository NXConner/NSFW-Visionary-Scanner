  ...
  steps: [
    {
      ...
      type: "prompt",
      customText:
        "Welcome to the scanner tutorial. I will teach you how to capture accurate measurements.",
      duration: 3000,
    ...
    },
    {
      ...
      type: "prompt",
      customText:
        "First, let's talk about lighting. Good lighting is essential for accurate scans.",
      duration: 3000,
    ...
    },
    {
      ...
      type: "prompt",
      customText:
        "The indicator at the top shows your current lighting level. Green means good lighting.",
      duration: 3000,
