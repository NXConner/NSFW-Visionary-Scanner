...
import { APP_NAME, SUPPORT_CONTACT_EMAIL, isLikelyEmail } from "@/config/brand";
              ...
              <div className="space-y-8 text-sm leading-relaxed">
                ...
                <section className="bg-destructive/10 border border-destructive/30 rounded-lg p-4">
                  ...
                  <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                    ...
                    <li>
                      Do not delay seeking medical attention based on information from this App
                    </li>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground">
                    You must be at least 18 years of age to use this App. By using the App, you
                    represent and warrant that you are at least 18 years old and have the legal
                    capacity to enter into these Terms. This App contains adult health content and
                ...
                <section>
                  ...
                  <p className="text-muted-foreground">
                    ...
                    for all activities under your account. You agree to provide accurate information
                    and to update it as necessary. We reserve the right to suspend or terminate
                ...
                <section>
                  ...
                  <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                    ...
                    <li>
                      <strong>Pro ($9.99/month):</strong> Enhanced tracking and analytics features
                    </li>
                    <li>
                      <strong>Premium ($19.99/month):</strong> Full access including AI features
                    </li>
                  </ul>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground">
                    You retain ownership of all content you create or upload to the App. By using
                    the App, you grant us a limited license to process your data solely for
                    providing the App's services. Your health data is stored locally on your device
                    with encryption. Cloud backup features (when enabled) use end-to-end encryption.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground">
                    All content, features, and functionality of the App (excluding user-generated
                    content) are owned by {APP_NAME} and are protected by international copyright,
                ...
                <section>
                  ...
                  <p className="text-muted-foreground">
                    You agree to indemnify and hold harmless {APP_NAME} and its officers, directors,
                ...
                <section>
                  ...
                  <p className="text-muted-foreground">
                    ...
                    right to use the App ceases immediately. You may delete your account and data at
                ...
                <section>
                  ...
                  <p className="text-muted-foreground">
                    ...
                    the United States, without regard to its conflict of law provisions. Any
                    disputes arising from these Terms shall be resolved in the courts of competent
                    jurisdiction.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <div className="mt-3 p-4 bg-muted/30 rounded-lg">
                    <p className="text-foreground font-medium">{APP_NAME} Support</p>
                    <p className="text-muted-foreground">
                      Email:{" "}
                      {isLikelyEmail(SUPPORT_CONTACT_EMAIL)
                        ? SUPPORT_CONTACT_EMAIL
                        : "Not configured (set VITE_SUPPORT_CONTACT_EMAIL)"}
                    </p>
                  </div>
                </section>
                ...
                <section className="border-t border-border pt-6">
                  <p className="text-center text-muted-foreground text-xs">
                    By using {APP_NAME}, you acknowledge that you have read, understood, and agree
