              ...
              <div className="space-y-6 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        {APP_NAME} is NOT a medical device and is NOT intended to diagnose, treat,
                        cure, or prevent any disease or medical condition. Always consult with a
                ...
                <section>
                  ...
                  <p className="text-muted-foreground mb-2">
                    By accessing or using {APP_NAME} ("the App"), you agree to be bound by these
                  ...
                  <p className="text-muted-foreground">
                    ...
                    regarding your use of the App and any related services.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground mb-2">
                    {APP_NAME} is a personal health tracking application designed for adult men to:
                  </p>
                ...
                <section>
                  ...
                  <div className="p-3 rounded-lg bg-destructive/10 border border-destructive/30 mb-3">
                    <p className="text-muted-foreground font-medium">
                      THE APP IS NOT A SUBSTITUTE FOR PROFESSIONAL MEDICAL ADVICE, DIAGNOSIS, OR
                      TREATMENT.
                    </p>
                  </div>
                  <p className="text-muted-foreground mb-2">
                    The App provides general health information for educational purposes only. You
                    should:
                  </p>
                  <ul className="list-disc list-inside text-muted-foreground space-y-1 ml-4">
                    <li>
                      Never disregard professional medical advice because of information from the
                      App
                    </li>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground mb-2">To use {APP_NAME}, you must:</p>
                  <ul className="list-disc list-inside text-muted-foreground space-y-1 ml-4">
                ...
                <section>
                  ...
                  <p className="text-muted-foreground mb-2">
                    Your privacy is paramount. {APP_NAME} is designed with privacy-first principles:
                  </p>
                  <ul className="list-disc list-inside text-muted-foreground space-y-1 ml-4">
                ...
                <section>
                  ...
                  <p className="text-muted-foreground mb-2">
                    {APP_NAME} offers both free and premium subscription tiers:
                  </p>
                  <ul className="list-disc list-inside text-muted-foreground space-y-1 ml-4">
                ...
                <section>
                  ...
                  <p className="text-muted-foreground">
                    All content, features, and functionality of the App are owned by {APP_NAME} and
                ...
                <section>
                  ...
                  <ul className="list-disc list-inside text-muted-foreground space-y-1 ml-4">
                    ...
                    <li>
                      We are not responsible for health decisions made based on App information
                    </li>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground">
                    You agree to indemnify and hold harmless {APP_NAME}, its affiliates, officers,
                    employees, and agents from any claims, damages, or expenses arising from your
                    use of the App, violation of these Terms, or infringement of any rights of
                    another party.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground mt-2">
                    Upon termination, your right to use the App ceases immediately. Data stored
                    locally on your device remains accessible to you.
                  </p>
                </section>
