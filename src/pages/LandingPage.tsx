            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <p className="text-muted-foreground text-lg">
                  We built {APP_NAME} with privacy as the foundation. Your sensitive health data is
          ...
          <Card className="max-w-4xl mx-auto bg-gradient-to-br from-primary/10 via-background to-accent/10 border-primary/20">
            <CardContent className="p-8 md:p-12 text-center space-y-6">
              ...
              <p className="text-muted-foreground text-lg max-w-xl mx-auto">
                Join thousands of users who trust {APP_SHORT_NAME} for their health tracking needs.
