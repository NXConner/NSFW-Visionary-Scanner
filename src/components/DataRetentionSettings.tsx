    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        <Alert>
          ...
          <AlertDescription>
            Your data will be automatically deleted after the retention period. You'll be notified before deletion.
          </AlertDescription>
        </Alert>
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="text-sm">
              ...
              <p className="text-muted-foreground">
                Automatic data retention ensures compliance with GDPR requirements for data minimization.
