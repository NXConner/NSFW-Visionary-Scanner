...
import { CheckCircle2, Circle, Flame, TrendingUp, Plus, Calendar, Target, BarChart3, X } from 'lucide-react'
...
export const HabitTracker = () => {
  ...
  const handleCreateHabit = async () => {
    ...
    try {
      ...
      setNewHabit({ name: '', description: '', category: 'custom', frequency: 'daily', target_value: 1, unit: 'times' })
      await loadData()
    } catch (error) {
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              ...
              {todayStatus.habits.map(habit => {
                ...
                const habitDef = (habit as any).habit_definition
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4 flex-1">
                          ...
                          <div className="flex-1">
                            <h4 className="font-semibold">{habit.custom_name || habitDef?.name || 'Habit'}</h4>
        ...
        <TabsContent value="habits" className="space-y-6">
          <Card variant="glass">
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={handleCreateHabit} disabled={loading} className="w-full" variant="gradient">
                  ...
                  <Card key={habit.id} variant="glass">
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <h4 className="font-semibold text-lg mb-2">{habit.custom_name || habitDef?.name || 'Habit'}</h4>
                          <p className="text-sm text-muted-foreground mb-4">{habitDef?.description}</p>
