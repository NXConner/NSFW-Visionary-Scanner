...
import { AlertTriangle, BookOpen, Info, Link, ShieldCheck } from "lucide-react";
...
import { BONDAGE_BDSM_CONTENT } from "./content";
...
export function BondageBdsmEducation(): JSX.Element {
  const content = BONDAGE_BDSM_CONTENT;
  ...
  const primaryOrder = ["overview", "key-components", "how-to", "equipment", "boundaries-safety", "aftercare", "faq"];
        ...
        <TabsContent value="resources" className="space-y-4 mt-5">
          <Card className="glass-card border-border/50">
            <CardHeader>
              ...
              <CardDescription>Resources and templates for safe, consensual BDSM exploration.</CardDescription>
            </CardHeader>
...
export default BondageBdsmEducation;
