...
import { AlertTriangle, BookOpen, Info, ShieldCheck } from "lucide-react";

import { Badge } from "@/components/ui/badge";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";

import { KAMA_SUTRA_CONTENT } from "./content";
...
export function KamaSutraEducation(): JSX.Element {
  const content = KAMA_SUTRA_CONTENT;
        ...
        <TabsContent value="resources" className="space-y-4 mt-5">
          <Card className="glass-card border-border/50">
            <CardHeader>
              ...
              <CardDescription>Resources for exploring the Kama Sutra.</CardDescription>
            </CardHeader>
...
export default KamaSutraEducation;
