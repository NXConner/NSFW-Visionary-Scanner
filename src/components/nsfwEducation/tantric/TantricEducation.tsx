...
import { AlertTriangle, BookOpen, Heart, Info, ShieldCheck } from "lucide-react";
...
import { TANTRIC_CONTENT } from "./content";
...
function toneBadgeVariant(tone?: EducationTone): "secondary" | "outline" {
  ...
  if (tone === "safety" || tone === "consent" || tone === "spiritual") return "secondary";
  return "outline";
}
...
export function TantricEducation(): JSX.Element {
  const content = TANTRIC_CONTENT;
  ...
  const primaryOrder = ["overview", "philosophy", "how-to", "techniques", "benefits", "boundaries-safety", "aftercare", "faq"];
    ...
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <div className="flex flex-wrap justify-center gap-2">
          ...
          <Badge variant="outline">Connection-focused</Badge>
        </div>
      </div>
        ...
        <TabsContent value="resources" className="space-y-4 mt-5">
          <Card className="glass-card border-border/50">
            <CardHeader>
              ...
              <CardDescription>Resources for deepening your Tantric practice.</CardDescription>
            </CardHeader>
...
export default TantricEducation;
