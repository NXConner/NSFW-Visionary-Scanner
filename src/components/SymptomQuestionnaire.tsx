        ...
        <Card className="glass-card border-border/50">
          ...
          <CardContent className="space-y-6">
            <div className="text-center">
              ...
              <Badge className={`mt-4 text-lg px-4 py-2 ${result.color}`}>{result.label}</Badge>
            </div>
            ...
            <div className="space-y-4 pt-4">
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-green-500/10 border border-green-500/20">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Your symptoms appear mild. Continue monitoring and maintain regular health
                      check-ups.
                    </p>
                  </div>
                </div>
              ...
              {result.level === "moderate" && (
                <div className="flex items-start gap-3 p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Consider scheduling an appointment with a urologist to discuss your symptoms
              ...
              {result.level === "high" && (
                <div className="flex items-start gap-3 p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Your symptoms suggest you should consult a urologist soon. Early treatment can
              ...
              <div className="p-4 rounded-lg bg-muted/30 border border-border/50">
                <p className="text-sm text-muted-foreground">
                  <strong className="text-foreground">Disclaimer:</strong> This questionnaire is for
                  informational purposes only and does not constitute medical advice. Always consult
