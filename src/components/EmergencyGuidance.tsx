...
import { Reveal, TiltCard } from "@/components/premium";
...
const redFlagSymptoms: EmergencySymptom[] = [
  {
    ...
    action:
      "SEEK EMERGENCY CARE IMMEDIATELY. This can cause permanent damage if not treated within 4-6 hours.",
  },
  {
    symptom: "Sudden Severe Pain",
    description: "Intense, sudden pain in the penis, testicles, or groin area",
    action:
      "Go to the emergency room immediately. Could indicate torsion, fracture, or other serious conditions.",
  },
  {
    symptom: "Blood in Urine or Semen",
    description:
      "Visible blood (hematuria or hematospermia) that persists or is accompanied by pain",
    action:
      "Seek urgent medical evaluation to rule out injury, infection, or other serious conditions.",
  },
  {
    symptom: "Penile Fracture",
    description:
      "A popping sound during sex followed by immediate loss of erection, severe pain, and rapid swelling",
  ...
  },
  {
    ...
    description:
      "Sudden severe testicular pain, swelling, nausea, and one testicle appearing higher",
...
export const EmergencyGuidance = () => {
  ...
  const { content: safetyVisuals } = useVisualContent({
    categories: [VISUAL_CONTENT_CATEGORIES.SAFETY, VISUAL_CONTENT_CATEGORIES.SYMPTOMS],
    autoLoad: true,
    autoInvert: true,
  });
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <Reveal delay={0.1}>
          <TiltCard
            variant="glass"
            maxTilt={3}
            className="mb-6 border-destructive/50 bg-destructive/5 rounded-2xl"
          >
            <div className="p-6">
                ...
                <AccordionContent>
                  <CardContent className="pt-0">
                    <div className="space-y-3">
                      {redFlagSymptoms.map((item, itemIndex) => (
                        <div
                          key={item.symptom}
                        ...
                        >
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              {safetyVisuals.length > 0 && itemIndex < safetyVisuals.length && (
                                <div className="mt-3 pt-3 border-t border-destructive/20">
                                  <VisualContentDisplay
                                    content={[safetyVisuals[itemIndex % safetyVisuals.length]]}
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <div className="p-2 rounded bg-warning/10 border border-warning/30">
                                <p className="text-xs font-medium text-warning">📋 {item.action}</p>
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      <h3 className="font-semibold text-primary">
                        📅 Schedule Appointment - 1-2 Weeks
                      </h3>
                      <p className="text-sm text-muted-foreground">
                        Should be evaluated but not urgent
                      </p>
                    </div>
                  </div>
                </AccordionTrigger>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    This guide is for reference only. When in doubt, always err on the side of
                    caution and seek medical attention. Early intervention often leads to better
                    outcomes.
                  </p>
