...
import { 
  ...
  Calendar, Brain, ChevronRight, AlertCircle 
} from 'lucide-react';
...
export const MeasurementPredictions = () => {
  ...
  const getTrendIcon = (trend: string) => {
    switch (trend) {
      ...
      case 'declining': return <TrendingUp className="w-4 h-4 text-destructive" />;
      ...
      <Card variant="glass">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-muted-foreground">
            Need at least 3 scans to generate predictions
          </p>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex items-start gap-2 p-3 rounded-lg bg-warning/10 border border-warning/20">
          ...
          <p className="text-xs text-muted-foreground">
            Predictions are based on your historical data trends and are for informational purposes only. 
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="text-center p-3 rounded-lg bg-background/50">
                  ...
                  <p className="text-xl font-bold">
                    {pred.current !== null ? pred.current : '-'}
                  </p>
                </div>
