...
export const TacticalScannerBackground = () => {
  ...
  return (
    ...
    >
      ...
      <div 
        className={`relative w-[95vw] h-[95vw] md:w-[75vw] md:h-[75vw] lg:w-[65vw] lg:h-[65vw] max-w-[800px] max-h-[800px] transition-transform duration-100 ${glitchActive ? 'animate-glitch' : ''}`}
        style={{
