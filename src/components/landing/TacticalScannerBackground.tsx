  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-[5%] rounded-full">
          ...
          <div className="absolute inset-[15%]">
            ...
            >
              ...
              <div className={`absolute inset-0 border-2 border-primary shadow-[0_0_30px_hsl(var(--primary)),inset_0_0_20px_hsl(var(--primary)/0.4)] transition-all duration-200 ${isInteracting ? 'scale-110 border-primary' : ''}`}>
                {/* Corner accents */}
              ...
              <div className="absolute inset-2 flex items-center justify-center">
                ...
                <div className={`absolute w-3 h-3 bg-primary rounded-full shadow-[0_0_15px_hsl(var(--primary))] transition-transform ${isInteracting ? 'scale-150' : 'animate-pulse'}`} />
              </div>
              ...
              <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 text-[8px] md:text-[10px] font-mono text-primary whitespace-nowrap">
                {isInteracting ? `X:${mousePos.x.toFixed(0)} Y:${mousePos.y.toFixed(0)}` : 'SCANNING...'}
              </div>
            </div>
          </div>
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-48 h-48 md:w-64 md:h-64 lg:w-80 lg:h-80 rounded-full bg-primary/20 blur-2xl animate-pulse" style={{ animationDuration: '3s' }} />
              </div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-32 h-32 md:w-48 md:h-48 lg:w-56 lg:h-56 rounded-full bg-primary/25 animate-ping" style={{ animationDuration: '4s' }} />
              </div>
        ...
        {/* Status text - top */}
        <div className={`absolute top-[2%] left-1/2 -translate-x-1/2 text-xs md:text-sm font-mono text-primary tracking-widest transition-opacity ${glitchActive ? 'opacity-50' : 'opacity-100'}`}>
