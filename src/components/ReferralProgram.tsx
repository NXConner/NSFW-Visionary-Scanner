...
import { 
  Share2, Copy, Gift, TrendingUp, Users, Award, 
  ExternalLink, Loader2, CheckCircle2, BarChart3
} from 'lucide-react'
import { 
...
export const ReferralProgram = () => {
  ...
  const [leaderboard, setLeaderboard] = useState<Array<{ display_name: string; referral_count: number; rank: number }>>([])
          ...
          {referralCode && (
            <>
              ...
              <div className="text-sm text-muted-foreground">
                <p>Share this link: <code className="text-xs bg-muted px-1 py-0.5 rounded">{referralUrl}</code></p>
              </div>

              <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                <div>
                  <div className="text-2xl font-bold text-primary">{referralCode.usage_count}</div>
                  <div className="text-sm text-muted-foreground">Total Referrals</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-primary">
                    {referralCode.max_uses ? `${referralCode.max_uses - referralCode.usage_count} left` : '∞'}
                  </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-4 rounded-lg bg-green-500/10">
                  <div className="text-2xl font-bold">{stats.completed_referrals}</div>
                ...
                <div className="p-4 rounded-lg bg-purple-500/10">
                  <div className="text-2xl font-bold">${stats.total_rewards_earned.toFixed(2)}</div>
