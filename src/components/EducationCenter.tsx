...
import {
  Heart, AlertTriangle, BookOpen, Search, ChevronRight, Shield,
  Activity, Eye, Bug, Thermometer, Droplets, Info, ExternalLink,
  Clock, CheckCircle, XCircle, HelpCircle, Stethoscope, Pill,
...
interface HealthTopic {
  id: string;
  title: string;
  category: 'curvature' | 'sti' | 'infection' | 'skin' | 'general';
  severity: 'informational' | 'mild' | 'moderate' | 'serious';
  overview: string;
  causes: string[];
  symptoms: string[];
  diagnosis: string;
...
const healthTopics: HealthTopic[] = [
  {
    ...
    category: 'curvature',
    severity: 'moderate',
    overview: "Peyronie's disease is a condition where fibrous scar tissue (plaque) forms inside the penis, causing curved, painful erections. It affects approximately 5-10% of men, typically between ages 40-70, though it can occur at any age. The curvature can make sexual intercourse difficult or impossible and may cause significant emotional distress.",
    causes: [
    ...
    diagnosis: "Diagnosis typically involves a physical examination where the doctor feels for plaque formations. An ultrasound may be used to examine blood flow and identify scar tissue location. You may be asked to bring photos of your erect penis showing the curvature angle. In some cases, injection of medication to induce erection may be used during examination.",
    treatment: [
    ...
    faqs: [
      { question: "Can Peyronie's disease go away on its own?", answer: "In about 12-13% of cases, the condition may improve without treatment. However, in most cases it stabilizes or worsens. Early treatment often yields better outcomes." },
      { question: "Is Peyronie's disease contagious?", answer: "No, Peyronie's disease is not contagious or sexually transmitted. It's caused by scar tissue formation inside the penis." },
      { question: "Will Peyronie's disease affect my fertility?", answer: "Peyronie's disease itself does not affect fertility or sperm production. However, if it causes significant erectile dysfunction, it may make conception more difficult." },
      { question: "How long does treatment take?", answer: "Treatment duration varies. Injection therapy typically takes 6-8 weeks. Traction devices are worn for 6-12 months. Surgery provides immediate correction but requires recovery time." }
    ]
  },
  {
    id: 'chlamydia',
    ...
    category: 'sti',
    severity: 'moderate',
    overview: "Chlamydia is one of the most common sexually transmitted infections caused by the bacterium Chlamydia trachomatis. It often has no symptoms, which makes it easy to spread unknowingly. If left untreated, it can cause serious complications including infertility.",
    causes: [
    ...
    diagnosis: "Chlamydia is diagnosed through urine tests or swab samples from the urethra. Testing is simple, quick, and widely available at clinics, doctor's offices, and through home testing kits.",
    treatment: [
    ...
    faqs: [
      { question: "Can I have chlamydia without knowing?", answer: "Yes, up to 50% of men with chlamydia have no symptoms. Regular testing is important for sexually active individuals." },
      { question: "Will chlamydia go away without treatment?", answer: "No. Without antibiotic treatment, chlamydia can persist and cause complications. However, it is easily cured with proper medication." }
    ]
  },
  {
    id: 'gonorrhea',
    ...
    category: 'sti',
    severity: 'moderate',
    overview: "Gonorrhea is a sexually transmitted infection caused by Neisseria gonorrhoeae bacteria. It can infect the genitals, rectum, and throat. Antibiotic-resistant strains are becoming more common, making treatment increasingly challenging.",
    causes: [
    ...
    diagnosis: "Diagnosed through urine tests or swab samples. Testing may need to include throat and rectal swabs depending on sexual practices.",
    treatment: [
    ...
    faqs: [
      { question: "Can gonorrhea be cured?", answer: "Yes, with proper antibiotic treatment. However, drug-resistant strains are emerging, making correct treatment important." },
      { question: "Can I get gonorrhea from oral sex?", answer: "Yes, gonorrhea can infect the throat through oral sex, though it's often asymptomatic in this location." }
    ]
  },
  {
    id: 'herpes',
    ...
    category: 'sti',
    severity: 'moderate',
    overview: "Genital herpes is caused by herpes simplex virus (HSV-1 or HSV-2). It's a lifelong infection that causes periodic outbreaks of painful sores. While there's no cure, medication can manage symptoms and reduce transmission risk.",
    causes: [
    ...
    diagnosis: "Diagnosed by visual examination of sores, viral culture from active sores, or blood tests for HSV antibodies.",
    treatment: [
    ...
    faqs: [
      { question: "Is herpes curable?", answer: "No, herpes is a lifelong infection. However, antiviral medications can effectively manage symptoms and reduce outbreaks." },
      { question: "Can I still have a normal sex life with herpes?", answer: "Yes. With proper management, communication, and precautions, people with herpes can have fulfilling sexual relationships." }
    ]
  },
  {
    id: 'syphilis',
    ...
    category: 'sti',
    severity: 'serious',
    overview: "Syphilis is a bacterial STI that progresses through stages if untreated. Early stages are highly treatable, but advanced syphilis can cause serious damage to the heart, brain, and other organs.",
    causes: [
    ...
    diagnosis: "Blood tests detect antibodies. Direct examination of sore fluid under microscope can identify bacteria.",
    treatment: [
    ...
    faqs: [
      { question: "Can syphilis be cured?", answer: "Yes, early-stage syphilis is easily cured with antibiotics. However, treatment cannot reverse damage already done in late stages." },
      { question: "How long do syphilis sores last?", answer: "Primary sores (chancres) heal on their own in 3-6 weeks, but the infection remains and progresses without treatment." }
    ]
  },
  {
    id: 'hpv',
    ...
    category: 'sti',
    severity: 'mild',
    overview: "Human papillomavirus (HPV) is the most common STI. Most infections clear on their own, but some strains cause genital warts while others can lead to cancer. Vaccines are highly effective at prevention.",
    causes: [
    ...
    diagnosis: "Genital warts diagnosed by visual examination. No routine HPV test for men, but warts can be biopsied if needed.",
    treatment: [
    ...
    faqs: [
      { question: "Can men get the HPV vaccine?", answer: "Yes, HPV vaccination is recommended for men up to age 45 and is highly effective at preventing warts and HPV-related cancers." },
      { question: "Will genital warts go away?", answer: "Visible warts may be treated, but the virus can remain in your body. Many people's immune systems eventually clear HPV infections." }
    ]
  },
  {
    id: 'balanitis',
    ...
    category: 'skin',
    severity: 'mild',
    overview: "Balanitis is inflammation of the head (glans) of the penis. It's common in uncircumcised men and can be caused by infections, skin conditions, or poor hygiene. Most cases are easily treated.",
    causes: [
    ...
    diagnosis: "Usually diagnosed by visual examination. Swabs may be taken to identify infection type. Blood glucose test if diabetes suspected.",
    treatment: [
    ...
    faqs: [
      { question: "Is balanitis an STI?", answer: "No, balanitis itself is not an STI, though it can sometimes be caused by STIs. Most cases are due to hygiene or yeast infections." },
      { question: "Can balanitis be prevented?", answer: "Yes, most cases are preventable with good hygiene - gently cleaning under the foreskin daily and keeping the area dry." }
    ]
  },
  {
    id: 'yeast-infection',
    ...
    category: 'infection',
    severity: 'mild',
    overview: "While often associated with women, men can also develop yeast infections caused by Candida fungus. It typically affects the head of the penis and can cause itching, redness, and discharge.",
    causes: [
    ...
    diagnosis: "Usually diagnosed by examination. Swab culture confirms Candida presence if needed.",
    treatment: [
    ...
    faqs: [
      { question: "Can men get yeast infections from women?", answer: "Yes, yeast infections can be passed between sexual partners, though they're not classified as STIs." },
      { question: "Do I need to treat my partner?", answer: "If your partner has symptoms, they should be treated. Treating partners may help prevent reinfection." }
    ]
  },
  {
    id: 'jock-itch',
    ...
    category: 'infection',
    severity: 'mild',
    overview: "Jock itch is a fungal infection affecting the groin, inner thighs, and buttocks. It causes an itchy, red, ring-shaped rash. While uncomfortable, it's generally harmless and responds well to treatment.",
    causes: [
    ...
    diagnosis: "Usually diagnosed by visual examination of the characteristic rash. Skin scraping may confirm fungal presence.",
    treatment: [
    ...
    faqs: [
      { question: "Is jock itch contagious?", answer: "Yes, the fungus can spread through direct contact or sharing towels and clothing. It can also spread from your own athlete's foot." },
      { question: "How long does jock itch take to heal?", answer: "With treatment, jock itch usually clears up in 2-4 weeks. Continue treatment for the full recommended time to prevent recurrence." }
    ]
  },
  {
    id: 'phimosis',
    ...
    category: 'skin',
    severity: 'moderate',
    overview: "Phimosis is a condition where the foreskin is too tight to be pulled back over the head of the penis. It's normal in young children but can cause problems in older boys and men.",
    causes: [
    ...
    diagnosis: "Diagnosed by physical examination. Doctor will assess severity and look for underlying causes.",
    treatment: [
    ...
    faqs: [
      { question: "Can phimosis be treated without surgery?", answer: "Yes, most cases respond to steroid creams and gentle stretching. Surgery is reserved for cases that don't respond to conservative treatment." },
      { question: "Is phimosis dangerous?", answer: "Phimosis itself isn't dangerous, but it can lead to infections and hygiene problems. Paraphimosis (foreskin stuck behind glans) is a medical emergency." }
    ]
  },
  {
    ...
    category: 'general',
    severity: 'moderate',
    overview: "Erectile dysfunction (ED) is the inability to get or maintain an erection firm enough for sex. Occasional ED is common, but frequent problems may indicate underlying health conditions requiring treatment.",
    causes: [
    ...
    diagnosis: "Physical exam, blood tests (testosterone, blood sugar, cholesterol), and questionnaires about symptoms. Ultrasound or injection tests may assess blood flow.",
    treatment: [
    ...
    faqs: [
      { question: "Is ED a normal part of aging?", answer: "While ED becomes more common with age, it's not an inevitable part of aging. Many underlying causes are treatable at any age." },
      { question: "Can ED be a sign of heart disease?", answer: "Yes, ED can be an early warning sign of cardiovascular disease. The blood vessels in the penis are smaller and may show damage before larger vessels." }
    ]
  }
];
            ...
            <div className="flex items-start justify-between flex-wrap gap-4">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <Badge variant="outline">{categoryLabels[selectedTopic.category]}</Badge>
                  <Badge className={severityColors[selectedTopic.severity]}>
                    {selectedTopic.severity.charAt(0).toUpperCase() + selectedTopic.severity.slice(1)}
                  </Badge>
                </div>
        ...
        <Tabs defaultValue="overview" className="space-y-6">
          ...
          <TabsContent value="overview" className="space-y-6">
            <Card variant="glass">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground leading-relaxed">{selectedTopic.overview}</p>
                {/* Visual content for condition */}
                {healthVisuals.length > 0 && (
                  <div className="pt-4 border-t border-border/50">
                    <VisualContentDisplay
                      content={healthVisuals.filter(v =>
                        v.tags.some(tag => selectedTopic.title.toLowerCase().includes(tag) || tag.includes(selectedTopic.title.toLowerCase().split(' ')[0]))
                      ).slice(0, 2)}
            ...
            <Card variant="glass">
              ...
              <CardContent>
                <ul className="space-y-2">
                  {selectedTopic.causes.map((cause, i) => (
            ...
            <Card variant="glass">
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed">{selectedTopic.diagnosis}</p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="symptoms" className="space-y-6">
              ...
              <CardContent className="space-y-4">
                ...
                {healthVisuals.length > 0 && (
                  <div className="pt-4 border-t border-border/50">
                    <VisualContentDisplay
                      content={healthVisuals.filter(v =>
                        v.tags.some(tag => selectedTopic.title.toLowerCase().includes(tag) || tag.includes('symptom'))
                      ).slice(0, 1)}
            ...
            <Card variant="glass" className="border-warning/30 bg-warning/5">
              ...
              <CardContent>
                <ul className="space-y-2">
                  {selectedTopic.whenToSeeDoctor.map((item, i) => (
                    <li key={i} className="flex items-start gap-3">
            ...
            <Card variant="glass">
              ...
              <CardContent>
                <ul className="space-y-3">
                  {selectedTopic.treatment.map((treatment, i) => (
          ...
          <TabsContent value="prevention" className="space-y-6">
            <Card variant="glass">
              ...
              <CardContent>
                <div className="grid md:grid-cols-2 gap-3">
                  {selectedTopic.prevention.map((tip, i) => (
      ...
      <Card variant="glass">
        <CardHeader>
          ...
          <p className="text-muted-foreground">
            Comprehensive information about penis health conditions, STIs, and when to seek medical attention.
          </p>
        </CardHeader>
        <CardContent>
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                ...
                physician or other qualified health provider with any questions about a medical condition. 
