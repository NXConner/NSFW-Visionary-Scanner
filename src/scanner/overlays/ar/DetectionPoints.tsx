    ...
    <g className="detection-points">
            ...
            {showLabels && (
              <g transform={`translate(${landmark.point.x + pointSize + 8}, ${landmark.point.y})`}>
                ...
                >
                  ...
                  <tspan fill="rgba(255,255,255,0.7)"> {Math.round(landmark.confidence * 100)}%</tspan>
                </text>
              </g>
            )}
          </g>
      ...
      {!showLabels && landmarks.length > 0 && (
        <g transform="translate(10, 10)" className="point-legend">
          ...
          <text x="22" y="18" fill="white" fontSize="9" fontFamily="system-ui, sans-serif">Reference</text>
          
          {/* Measurement point */}
          <circle cx="12" cy="30" r="4" fill="#38bdf8" />
          <text x="22" y="34" fill="white" fontSize="9" fontFamily="system-ui, sans-serif">Measure</text>
          
          {/* Anchor point */}
          <circle cx="12" cy="46" r="4" fill="#a78bfa" />
          <text x="22" y="50" fill="white" fontSize="9" fontFamily="system-ui, sans-serif">Anchor</text>
        </g>
      )}
    </g>
  );
