...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      restricted_content_audit_events: {
        Row: {
          allowed: boolean
          attempted_at: string
          context: Json
        ...
        Relationships: [
          {
            foreignKeyName: "restricted_content_audit_events_feature_key_fkey"
            columns: ["feature_key"]
            isOneToOne: false
            referencedRelation: "restricted_content_registry"
            referencedColumns: ["feature_key"]
          },
        ]
      }
      restricted_content_registry: {
        Row: {
          ...
          required_consent_policies: string[]
          requires_age_verification: boolean
          requires_direct_distribution: boolean
    ...
    Views: {
      ...
      restricted_content_runtime_guard: {
        Row: {
          content_policy: string | null
          distribution_channel: string | null
          nsfw_enabled: boolean | null
          restricted_content_enabled: boolean | null
          store_distribution: boolean | null
        }
        Relationships: []
      }
    }
    Functions: {
      ...
      current_content_policy: { Args: never; Returns: string }
      current_distribution_channel: { Args: never; Returns: string }
      ...
      is_restricted_content_enabled: { Args: never; Returns: boolean }
      is_store_distribution: { Args: never; Returns: boolean }
