...
import type { ProstateHealthGuide, TesticularHealthGuide } from "@/components/mensHealthGuide/types";
...
export const testicularHealthGuide: TesticularHealthGuide = {
  ...
  content: {
    ...
    commonConditions: [
      ...
      {
        name: "Hydrocele",
        description: "Fluid around testicle causing swelling. Usually painless. Get checked to rule out other causes.",
      },
      {
        name: "Epididymal Cyst",
        description: "Fluid-filled cyst on epididymis. Common, usually benign. Monitor for changes.",
      },
      {
        name: "Epididymitis",
        description: "Infection/inflammation of epididymis. Painful, may have fever. Requires antibiotics.",
      },
      {
        name: "Testicular Torsion",
        description: "EMERGENCY - testicle twists, cutting blood supply. Severe sudden pain. Seek immediate care.",
      },
    ],
  },
};
