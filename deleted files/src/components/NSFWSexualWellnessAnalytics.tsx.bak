...
export const NSFWSexualWellnessAnalytics = ({
  ...
  const functionChartData = functionTracking.slice(-30).map(entry => ({
    ...
    quality:
      entry.erection_quality === "rigid"
        ? 10
        : entry.erection_quality === "full"
          ? 8
          : entry.erection_quality === "partial"
            ? 5
            : 0,
    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <Card className="glass-card border-border/50">
        <CardHeader>
          ...
          <CardDescription>
            Comprehensive tracking and analysis of sexual function, libido, satisfaction, and
            frequency
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          >
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setFunctionEntry({ ...functionEntry, entry_date: e.target.value })
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setFunctionEntry({
                          ...functionEntry,
                          erectile_function_score: parseInt(e.target.value) || undefined,
                        })
                      }
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setFunctionEntry({
                          ...functionEntry,
                          erection_duration_minutes: parseInt(e.target.value) || undefined,
                        })
                      }
                    />
                  </div>
                  <Button onClick={handleTrackFunction} className="w-full">
                    Track Function
                  </Button>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setLibidoEntry({
                          ...libidoEntry,
                          libido_level: parseInt(e.target.value) || undefined,
                        })
                      }
                    />
                  </div>
                  <Button
                    onClick={async () => {
                      ...
                      try {
                        const result = await trackLibido(
                          libidoEntry.entry_date,
                          libidoEntry.libido_level,
                          libidoEntry,
                        );
                        if (result) {
                          setLibidoEntry({
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setSatisfactionEntry({ ...satisfactionEntry, entry_date: e.target.value })
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setSatisfactionEntry({
                          ...satisfactionEntry,
                          overall_satisfaction: parseInt(e.target.value) || undefined,
                        })
                      }
                    />
                  </div>
                  <Button
                    onClick={async () => {
                      if (
                        !satisfactionEntry.entry_date ||
                        !satisfactionEntry.overall_satisfaction
                      ) {
                        toast.error("Please fill in all required fields");
                        return;
                      }
                      try {
                        const result = await trackSatisfaction(
                          satisfactionEntry.entry_date,
                          satisfactionEntry.overall_satisfaction,
                          satisfactionEntry,
                        );
            ...
            <TabsContent value="wellness" className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <Button onClick={handleCalculateWellness}>Calculate Score</Button>
              </div>
