  ...
  try {
    ...
    try {
      ...
      analysis = {
        overallHealth: "fair",
        confidenceLevel: 50,
        curvatureAssessment: { detected: false, estimatedAngle: null, direction: null, severity: null },
        skinHealth: { status: "healthy", observations: ["Unable to fully analyze image"] },
        recommendations: ["Please ensure image is clear and well-lit", "Consider retaking the scan"],
        urgency: "routine",
        disclaimer: "This assessment is for educational purposes only. Please consult a healthcare provider.",
        rawResponse: content
      };
    }
